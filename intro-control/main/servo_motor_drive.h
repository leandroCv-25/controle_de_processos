...
#define BDC_PID_LOOP_PERIOD_MS 1                                                    // calculate the motor speed every 1ms
...
typedef struct
{
    ...
    int delta_pulses;
    int home_sensor;
    int bdc_mcpwm_gpio_a;
    int bdc_mcpwm_gpio_b;
    int bdc_encoder_gpio_a;
    int bdc_encoder_gpio_b;
    int group_id_timer;
    int isReady;
